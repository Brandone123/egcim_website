                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7 col-lg-8 col-md-8 col-sm-8">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInLeft" data-delay="0.2s" style="font-size: 36px; text-align: center">ECOLE DE GENIE CHIMIQUE ET DES INDUSTRIES MINERALES</h1>
                                    <p data-animation="fadeInLeft" data-delay="0.4s" align="center" style="font-style: 36px">EGCIM</p>
