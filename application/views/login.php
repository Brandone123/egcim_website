...
<!--===============================================================================================-->	
	<link rel="icon" href="<?= base_url()?>assets/img/logoEGCIM40.png">
<!--===============================================================================================-->
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="https://egcim-univ-ndere.cm/assets/img/EGCIM-logo.png" alt="IMG">
				</div>

				<form class="login100-form validate-form" action="<?= site_url('login/post')?>" method="post">
					<span class="login100-form-title">
						Connexion d'un personnel de EGCIM
					</span>
