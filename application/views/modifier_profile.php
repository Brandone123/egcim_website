              ...
              <div class="card">
                <div class="card-body">
                  <form method="post" action="<?= site_url('profile/modifier_post')?>" enctype="multipart/form-data">
                    <!-- <div class="row">
                      <div class="col-sm-3">
                        <h6 class="mb-0">Modifier votre Mot de passe</h6>
                      </div>
                      ...
                      <div class="col-sm-9 text-secondary">
                        <select name="departement" class="form-control">
                          <?php foreach ($departements as $key) {?>
                            <option value="<?= $key->id_depart; ?>"><?= $key->nom_departement ; ?></option>
                          <?php } ?>
                        </select> 
                      </div>
                    </div>
              ...
              <div class="card mb-3">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <textarea name="bibliographie" class="form-control"><?= $user->bibliographie;?></textarea>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <textarea name="enseignements" class="form-control"><?= $user->enseignements;?></textarea>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <input type="text" name="axe_recherche" class="form-control" value="<?= $user->axe_recherche;?>">
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Equipe de recherche</h6>
                    </div>
                    <div class="col-sm-9 text-secondary">
                      <input type="text" name="equipe" class="form-control" value="<?= $user->equipe;?>">
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Domaine de recherche</h6>
                    </div>
                    <div class="col-sm-9 text-secondary">
